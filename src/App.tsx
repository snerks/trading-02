...
export interface TimeSeriesIntraday {
  "Meta Data": MetaData;
...
// type TimeSeries5MinKeys = keyof TimeSeries5Min;
...
// interface TimeSeriesItemPointData {
//   values: number[];
// }
...
function App() {
  ...
  const defaultIntraday: TimeSeriesIntraday = {
    "Meta Data": {
      "1. Information": "",
      "2. Symbol": "",
      "3. Last Refreshed": "",
    ...
    const fetchData = async () => {
      ...
      await fetch(
        ...
        .then((response) => {
          ...
          const typedResponse = response as TimeSeriesIntraday;

          console.log("typedResponse");
          console.log(typedResponse);

          // console.log(response);
          setTimeSeriesIntraday(response);
          ...
          console.log(dateTimeItems);
          setTimeSeriesItems(dateTimeItems);
  ...
  return (
    <>
      ...
      {/* <ul>
        {timeSeriesIntraday &&
          timeSeriesIntraday['Time Series (5min)'] &&
          timeSeriesIntraday['Time Series (5min)'] && Object.keys(timeSeriesIntraday['Time Series (5min)']).map(keyName => <li key={keyName}>{keyName}</li>)}
      </ul> */}

      {/* <pre>{JSON.stringify(timeSeriesIntraday, null, 2)}</pre> */}
    </>
  )
}
